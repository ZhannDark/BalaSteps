...
const CenterDetails = () => {
    ...
    useEffect(() => {
        const fetchPost = () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const res = yield axios.get(`https://project-back-81mh.onrender.com/info-hub/centers/${id}/`);
                setPost(res.data);
    ...
    const handleAddComment = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const res = yield axios.post(`https://project-back-81mh.onrender.com/info-hub/centers/${id}/comment/`, { content: newComment, rating: newRating }, { headers: { Authorization: `Bearer ${token}` } });
