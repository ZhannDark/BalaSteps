...
interface SpecialistDetailsType {
  id: string;
  name: string;
  description: string;
  photo?: string;
...
const SpecialistDetails = () => {
  ...
  const [post, setPost] = useState<SpecialistDetailsType | null>(null);
  ...
  const handleAddComment = async () => {
    ...
    try {
      const res = await axios.post(
        `https://project-back-81mh.onrender.com/info-hub/specialists/${id}/comment/`,
      ...
      <Layout style={{ marginLeft: collapsed ? 100 : 250 }}>
        ...
        <Content className="details-container">
          ...
          <div style={{ marginTop: 8 }}>
            <Text>Rate this specialist (required): </Text>
